...
public class SingingMateController {
    ...
    public ResponseEntity<ResultResponse> postSinging(@RequestBody SingingMateRequest request){
        ...
        return ResponseEntity.ok(ResultResponse.of(ResultCode.POST_SINGING_MATE_SUCCESS));
    }
    ...
    public ResponseEntity<ResultResponse> editSinging(@PathVariable Long singingId,
        ...
        return ResponseEntity.ok(ResultResponse.of(ResultCode.PUT_SINGING_MATE_SUCCESS));
    }
    ...
    public ResponseEntity<SingingMateInfoResponse> getSingingInfo(@PathVariable Long singingId){
        ...
        return ResponseEntity.ok(SingingMateInfoResponse.of(ResultCode.GET_SINGING_MATE_INFO_SUCCESS, data));
    }
    ...
    public ResponseEntity<ResultResponse> applySinging(@PathVariable Long singingId,
        ...
        ResultCode result = singingMateService.applySinging(singingId,request);
    ...
    public ResponseEntity<ResultResponse> deleteSinging(@PathVariable Long singingId){
        ...
        return ResponseEntity.ok(ResultResponse.of(ResultCode.DELETE_SINGING_MATE_SUCCESS));
    }
    ...
    public ResponseEntity<ResultResponse> completeSinging(@PathVariable Long singingId){
        ...
        return ResponseEntity.ok(ResultResponse.of(ResultCode.COMPLETE_SINGING_MATE_SUCCESS));
    }
    ...
    public ResponseEntity<ResultResponse> acceptSinging(@PathVariable Long singingId,
        ...
        ResultCode result = singingMateService.acceptSinging(singingId,request);
        return ResponseEntity.ok(ResultResponse.of(result));
    ...
    public ResponseEntity<SingingMateListResponse> getAllSinging(){
        ...
        return ResponseEntity.ok(SingingMateListResponse.of(ResultCode.GET_SINGING_MATE_LIST_SUCCESS, data));
    }
    ...
    public ResponseEntity<SingingMateListResponse> getSearchedSinging(@RequestParam String keyword){
        ...
        return ResponseEntity.ok(SingingMateListResponse.of(ResultCode.GET_SEARCHED_SINGING_MATE_LIST_SUCCESS,data));
    }
    ...
    public ResponseEntity<SingingMateListResponse> getMySinging(){
        ...
        return ResponseEntity.ok(SingingMateListResponse.of(ResultCode.GET_MY_SINGING_MATE_LIST_SUCCESS,data));
    }
